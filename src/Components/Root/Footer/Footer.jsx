...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-800 text-gray-100">
                ...
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full ">
                            <img src="https://i.ibb.co/b1BfNGY/1.png" alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold">FUTURE STATION</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 <strong>FUTURE STATION LTD,</strong> All rights reserved.</div>
        </footer>
    );
};
