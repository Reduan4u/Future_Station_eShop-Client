        ...
        <div className=" ">
            <div className="navbar max-w-6xl mx-auto">
                <div className="navbar-start">
                    ...
                    <div >
                        {/* <h1>FUTURE <br />STATION</h1> */} {/* https://i.ibb.co/8BXYrvP/rsz-cover.png https://i.ibb.co/b1BfNGY/1.png*/}
                        <img className="w-2/3  lg:w-2/4 md:w-2/4 sm:w-2/4 " src="https://i.ibb.co/b1BfNGY/1.png" alt="" />
                    </div>
                </div>
