                        ...
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                <div className="space-y-1">
                                    <h3 className="text-lg font-semibold leadi sm:pr-8">{addedProductName}</h3>
                                    <p className="text-sm dark:text-gray-400">{addedProductType}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-lg font-semibold">{addedProductPrice}.00$</p>
                                </div>
                            </div>
                            <div className="flex text-sm gap-4 ">
                                <button onClick={() => handleRemove(_id)} type="button" className="btn btn-secondary btn-outline flex items-center px-4 py-1 pl-0 space-x-1">
                                ...
                                <button type="button" className=" btn btn-outline btn-success flex items-center px-2 py-1 space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current">
